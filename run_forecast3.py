...
ax.fill_between(x_fc_r, R['fc']['p05'], R['fc']['p95'],
                alpha=0.13, color=C_KF, label='5th–95th (90% CI)')
ax.fill_between(x_fc_r, R['fc']['p10'], R['fc']['p90'],
                alpha=0.22, color=C_KF, label='10th–90th (80% CI)')
...
# Observed — black edge when outside 90% CI
...
ax.plot([], [], 'o', color=C_OBS, markeredgecolor='black',
    markeredgewidth=1.6, label='Outside 90% CI')
...
ax.fill_between(x_fc_t, T['fc']['p05'], T['fc']['p95'],
                alpha=0.13, color=C_TMP, label='5th–95th (90% CI)')
ax.fill_between(x_fc_t, T['fc']['p10'], T['fc']['p90'],
                alpha=0.22, color=C_TMP, label='10th–90th (80% CI)')
